...
public class Belgas extends Persona {

    public Belgas(Integer peso, List<Jarra> jarrasCompradas, Boolean leGustaMusicaTradicional, Integer nivelAguante) {
